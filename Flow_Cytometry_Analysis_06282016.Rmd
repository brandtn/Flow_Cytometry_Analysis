...
flowData <- read.flowSet(path = "/Users/Brandt/Desktop/GAP1_GFP_ScreenTest/GAP1_GFP_Plate01_Screen/GAP1_GFP_Plate01_SC_FCS_Files", pattern=".fcs", alter.names=TRUE)

sample.sheet <- read.csv("/Users/Brandt/Desktop/GAP1_GFP_ScreenTest/GAP1_GFP_Plate01_Screen/GAP1_GFP_Plate01_SC_Screen_Sheet.csv")
...
filterData <- dataLGCLTransform#Subset(dataLGCLTransform, rectGate) 
...
xyplot(FSC.A ~ SSC.A, data=dataLGCLTransform, ylim=c(4,8),xlim=c(0,8), displayFilter=TRUE, filter=rectGate, smooth=F, xbin=128, stat=T, pos=0.5, abs=T)
```
...
xyplot(FL1.A ~ FSC.A, data=dataLGCLTransform, ylim=c(0,8),xlim=c(4,8),smooth=F, xbin=128)

##Plot FFS versus SSC
xyplot(SSC.A ~ FSC.A, data=dataLGCLTransform, ylim=c(3,8),xlim=c(4,8), smooth=F, xbin=128)
...
xyplot(FL1.A ~ FL2.A, data=dataLGCLTransform, ylim=c(0,8),xlim=c(0,6), smooth=F, xbin=128)
